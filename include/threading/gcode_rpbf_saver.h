...
class GCodeRPBFSaver : public QThread {
  ...
  public:
    ...
    GCodeRPBFSaver(QString tempLocation, QString path, QString filename, QString text, GcodeMeta meta,
                   double clockAngle, bool offset_enabled, Angle sector_width = Angle());
