...
class MeshLoader : public QThread {
  ...
  public:
    ...
    MeshLoader(QString file_path, MeshType mt = MeshType::kBuild, QMatrix4x4 transform = QMatrix4x4(),
    ...
    static QVector<MeshData> LoadMeshes(QString file_path, MeshType mt = MeshType::kBuild,
