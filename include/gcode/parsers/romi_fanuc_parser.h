...
// Romi_Fanuc dedicated parser currently unnecessary as its only current handlers are M3/M5
...
namespace ORNL
{
  ...
  class RomiFanucParser : public CommonParser
  {
      public:
          ...
          RomiFanucParser(GcodeMeta meta, bool allowLayerAlter);
