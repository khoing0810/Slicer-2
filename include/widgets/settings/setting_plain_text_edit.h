...
namespace ORNL {
class SettingTab;
//! \brief Widget to provide custom plain text edit
//! Supports multiline_text setting type
class SettingPlainTextEdit : public QPlainTextEdit, public SettingRowBase {
  ...
  public:
    ...
    SettingPlainTextEdit(SettingTab* parent, QSharedPointer<SettingsBase> sb, QString key, fifojson json,
