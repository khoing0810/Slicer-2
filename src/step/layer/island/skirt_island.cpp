...
namespace ORNL {
SkirtIsland::SkirtIsland(const PolygonList& geometry, const QSharedPointer<SettingsBase>& sb,
...
void SkirtIsland::optimize(int layerNumber, Point& currentLocation,
