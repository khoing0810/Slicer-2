...
void MarlinParser::config() {
    ...
    addCommandMapping("M605", std::bind(&MarlinParser::M605Handler, this, std::placeholders::_1));
    addCommandMapping("T0", std::bind(&MarlinParser::THandler, this, std::placeholders::_1));
    addCommandMapping("T1", std::bind(&MarlinParser::THandler, this, std::placeholders::_1));
    addCommandMapping("T2", std::bind(&MarlinParser::THandler, this, std::placeholders::_1));
    addCommandMapping("T3", std::bind(&MarlinParser::THandler, this, std::placeholders::_1));
    addCommandMapping("T4", std::bind(&MarlinParser::THandler, this, std::placeholders::_1));
    addCommandMapping("T5", std::bind(&MarlinParser::THandler, this, std::placeholders::_1));
    addCommandMapping("T6", std::bind(&MarlinParser::THandler, this, std::placeholders::_1));
}
