...
void IngersollParser::config() {
    ...
    addCommandMapping("G0", std::bind(&IngersollParser::G0Handler, this, std::placeholders::_1));

    addCommandMapping("G1", std::bind(&IngersollParser::G1Handler, this, std::placeholders::_1));
}
