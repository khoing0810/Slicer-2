...
namespace ORNL {
AML3DWriter::AML3DWriter(GcodeMeta meta, const QSharedPointer<SettingsBase>& sb) : WriterBase(meta, sb) {}

QString AML3DWriter::writeSettingsHeader(GcodeSyntax syntax) {
    QString text = "";
...
QString AML3DWriter::writeBeforePart(QVector3D normal) {
    QString rv;
    return rv;
}

QString AML3DWriter::writeBeforeIsland() {
    QString rv;
    return rv;
}

QString AML3DWriter::writeBeforeScan(Point min, Point max, int layer, int boundingBox, Axis axis, Angle angle) {
    QString rv;
    return rv;
}

QString AML3DWriter::writeBeforeRegion(RegionType type, int pathSize) {
    QString rv;
    return rv;
}

QString AML3DWriter::writeBeforePath(RegionType type) {
    QString rv;
...
QString AML3DWriter::writeTravel(Point start_location, Point target_location, TravelLiftType lType,
...
QString AML3DWriter::writeArc(const Point& start_point, const Point& end_point, const Point& center_point,
...
QString AML3DWriter::writeAfterRegion(RegionType type) {
    QString rv;
    return rv;
}

QString AML3DWriter::writeAfterScan(Distance beadWidth, Distance laserStep, Distance laserResolution) {
    QString rv;
    return rv;
}

QString AML3DWriter::writeAfterIsland() {
    QString rv;
    return rv;
}

QString AML3DWriter::writeAfterPart() {
    QString rv;
    return rv;
}

QString AML3DWriter::writeAfterLayer() {
    QString rv;
...
QString AML3DWriter::writePurge(int RPM, int duration, int delay) {
    QString rv;
    return rv;
}

QString AML3DWriter::writeDwell(Time time) {
    if (time > 0)
...
QString AML3DWriter::writeTamperOn() {
    QString rv;
    return rv;
}

QString AML3DWriter::writeTamperOff() {
    QString rv;
    return rv;
}
...
QString AML3DWriter::writeExtruderOff(int extruder_number) {
...
QString AML3DWriter::writeCoordinates(Point destination) {
    QString rv;
