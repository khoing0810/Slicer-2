...
namespace ORNL {
GudelWriter::GudelWriter(GcodeMeta meta, const QSharedPointer<SettingsBase>& sb) : WriterBase(meta, sb) {}
...
QString GudelWriter::writeBeforePart(QVector3D normal) {
    QString rv;
    return rv;
}

QString GudelWriter::writeBeforeIsland() {
    QString rv;
    return rv;
}

QString GudelWriter::writeBeforeRegion(RegionType type, int pathSize) {
    QString rv;
    return rv;
}

QString GudelWriter::writeBeforePath(RegionType type) {
    QString rv;
...
QString GudelWriter::writeTravel(Point start_location, Point target_location, TravelLiftType lType,
...
QString GudelWriter::writeArc(const Point& start_point, const Point& end_point, const Point& center_point,
...
QString GudelWriter::writeAfterPath(RegionType type) {
    QString rv;
    if (!m_spiral_layer) {
        rv += writeExtruderOff();
...
QString GudelWriter::writeAfterRegion(RegionType type) {
    QString rv;
    return rv;
}

QString GudelWriter::writeAfterIsland() {
    QString rv;
    return rv;
}

QString GudelWriter::writeAfterPart() {
    QString rv;
    return rv;
}

QString GudelWriter::writeAfterLayer() {
    QString rv;
...
QString GudelWriter::writeCoordinates(Point destination) {
    QString rv;
