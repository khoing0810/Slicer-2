...
Theme::Theme(int themeNum) {
    m_dotColors << Qt::darkGreen << Qt::darkYellow << QColor(255, 172, 28) << Qt::darkBlue
                << Qt::white; // vector has to be populated
...
void Theme::chooseTheme(int themeNum) {
    ...
    if (themeNum == 1) {
        ...
        this->setBgColor(0.169, 0.196,
                         0.203); // this is extended RGB because that is what QOpenGLWidget (base_view) requires
